...
void ThreadFlush(thread_handle_t th);
...
void ForwardThreadArgumentsWithIndices(CB cb, TUPLE &args, std::integer_sequence<size_t, INDICES...>)
{
...
void ForwardArgumentsThread(void *ptr)
{
	...
	ForwardThreadArgumentsWithIndices(args->cb, args->args, std::make_index_sequence<sizeof...(ARGS)>());
	delete args;
}

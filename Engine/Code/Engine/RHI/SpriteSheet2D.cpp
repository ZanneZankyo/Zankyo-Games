...
SpriteSheet2D::SpriteSheet2D(const Texture2D* texture, const IntVector2 layout)
	: m_texture(texture)
	, m_tileLayout(layout)
{
}

AABB2 SpriteSheet2D::GetTextCoordsForSpriteIndex(int spriteIndex) const
{
...
AABB2 SpriteSheet2D::GetTextCoordsForSpriteIndex(const IntVector2 & spriteIndex) const
{
